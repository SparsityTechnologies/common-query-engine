...
public class CloudMdSQLMapEntry extends AbstractMap.SimpleEntry<String, Object> {

	public CloudMdSQLMapEntry(String key, Object value) {
		super(key, value);
	}

	public CloudMdSQLMapEntry(Entry<String, Object> entry) {
		super(entry);
	}

...
public class CQEInternalDriver implements ModuleControl, InternalDriverInterface {

	private static final Object syncMe = new Object();
	private static CQEInternalDriver activeDriver;
	...
	*/
	...
	public void boot(boolean create, Properties properties) throws StandardException {
		...
		synchronized (CQEInternalDriver.syncMe)
		{
			CQEInternalDriver.activeDriver = this;
		}
	...
	public void stop() {
		...
		synchronized (CQEInternalDriver.syncMe)
		{
			CQEInternalDriver.activeDriver = null;
		}
	...
	*/
		...
		try {
			...
			*/
			...
			if (shutdown) {				
				...
				//
				if (CQEInternalDriver.getDatabaseName(url, finfo).length() == 0) {
					//
                    ...
                    if (finfo.getProperty(Attribute.DEREGISTER_ATTR) != null) {
                        boolean deregister = Boolean.valueOf(
                                ...
                                .booleanValue();
                        CQEInternalDriver.setDeregister(deregister);
                    }
    ...
    public static final class LoginCallable implements
        ...
        private CQEInternalDriver _driver;
        private String _url;
        private Properties _info;

        public LoginCallable(CQEInternalDriver driver, String url, Properties info) {
            _driver = driver;
            _url = url;
            _info = info;
        }
        ...
        public EmbedConnection call() throws SQLException {
            ...
            CQEInternalDriver driver = _driver;
            _url = null;
            _info = null;
            _driver = null;
	...
	*/
    ...
    public EmbedConnection getNewEmbedConnection(String url, Properties info)
            throws SQLException {
        return new EmbedConnection(this, url, info, new CQETransactionalResourceImpl(this, url, info));
    }
	...
	*/
    ...
    public DriverPropertyInfo[] getPropertyInfo(String url, Properties info)
        ...
        String dbname = CQEInternalDriver.getDatabaseName(url, info);
    ...
    static void setDeregister(boolean deregister) {
    	CQEInternalDriver.deregister = deregister;
    }
    ...
    static boolean getDeregister() {
        return CQEInternalDriver.deregister;
    }

...
public class SelectNode extends ResultSetNode
{
	...
	public SelectNode(ContextManager cm){
		 super(cm);
	}
    ...
    public WindowList getWindow(){
    	return windows;
    }
    
    public OptimizerPlan getOverwritingPlan(){
    	return overridingPlan;
    }

...
public class EmbedConnection implements EngineConnection
{
	...
	*/
	private InternalDriverInterface factory;
	...
	*/
    ...
    public EmbedConnection(InternalDriverInterface driver, String url, Properties info)
   		 throws SQLException
   	{
    	this(driver, url, info, new TransactionResourceImpl(driver, url, info));
   	}
    
	// create a new Local Connection, using a new context manager
	//
	public EmbedConnection(InternalDriverInterface driver, String url, Properties info, TransactionResourceImpl tr)
		 throws SQLException
	{
    ...
    */
	...
	public void setAutoCommit(boolean autoCommit) throws SQLException {
		...
		if (this.autoCommit != autoCommit && !this.autoCommit){
			commit();
		}
	...
	final protected Object getConnectionSynchronization()
  {
	...
	*/
	...
	public final InternalDriverInterface getLocalDriver()
	{
		if (SanityManager.DEBUG)
			SanityManager.ASSERT(!isClosed(), "connection is closed");

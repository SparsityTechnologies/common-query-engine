...
{
    // Allowed kinds
    public final static int K_DIVIDE = 0;
    public final static int K_MINUS = 1;
    public final static int K_PLUS = 2;
    public final static int K_TIMES = 3;
    public final static int K_MOD = 4;

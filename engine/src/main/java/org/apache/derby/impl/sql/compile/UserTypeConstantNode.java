...
public class UserTypeConstantNode extends ConstantNode {
	...
	*/
    ...
    public UserTypeConstantNode(Date d, ContextManager cm)
            throws StandardException {
    ...
    public UserTypeConstantNode(Time t, ContextManager cm)
            throws StandardException {
    ...
    public UserTypeConstantNode(Timestamp t, ContextManager cm)
            throws StandardException {
     ...
     * @throws StandardException
     */
    public UserTypeConstantNode(DataValueDescriptor dvd, ContextManager cm)
            throws StandardException {
        super(getTypeId(dvd),
              dvd == null,
              getWidth(dvd),

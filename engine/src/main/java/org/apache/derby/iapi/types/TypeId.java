...
public final class TypeId
{
	...
	// in decimal digits, rather than number of bits, so need a separate constant.
        ...
        */
        ...
        public static final TypeId TINYINT_ID = create(
        ...
        public static final TypeId REAL_ID = create(
        ...
        public static final TypeId DECIMAL_ID =  new TypeId(
            StoredFormatIds.DECIMAL_TYPE_ID,
            new DecimalTypeIdImpl(false));

        public static final TypeId NUMERIC_ID = new TypeId(
            StoredFormatIds.DECIMAL_TYPE_ID,
